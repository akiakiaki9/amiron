...
import "./commonHall.css"; // переименуйте файл стилей

export default function CommonHallPage() {
    const [isModalOpen, setIsModalOpen] = useState(false);
    const [activeCategory, setActiveCategory] = useState("all");
    const [isMobileFilterOpen, setIsMobileFilterOpen] = useState(false);

    // Используем commonHall вместо banquetHall
    const data = menuData.commonHall;
    ...
    return (
        <>
            ...
            <button onClick={handleBooking} className="floating-order-btn">
                <FaCalendarAlt />
